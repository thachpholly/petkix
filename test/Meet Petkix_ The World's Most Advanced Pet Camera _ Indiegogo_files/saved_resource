! function(e) {
    ...
    var ye, ve, be, ge, Ee, we, Se, Pe, ke = function(e) {
        ...
        He = function(e) {
            if (e === Fe.unknown) throw new Oe("It looks like you're using an older Stripe key. In order to use this API, you'll need to use a modern API key, which is prefixed with 'pk_live_' or 'pk_test_'.\n    You can roll your publishable key here: https://dashboard.stripe.com/account/apikeys")
        },
                        ...
                        if ("valid" === o.type)
                            for (var i = {}, a = 0; a < o.value.length; a += 1) {
                                ...
                                if ("object" === (void 0 === c ? "undefined" : Ye(c)) && c && "string" == typeof c[e]) {
                                    var s = c[e];
                                    if (i[s]) return Ke(new Oe("Duplicate value for " + e + ": " + s + ". The property '" + e + "' of '" + r.path.join(".") + "' has to be unique."));
                                    i[s] = !0
                                }
                            }
                        return o
            ...
            return function(t) {
                return function(n, r) {
                    if (n && "object" === (void 0 === n ? "undefined" : Ye(n)) && !Array.isArray(n)) {
                        ...
                        if (i && e) return Ke(new Oe("Invalid " + r.label + " parameter: " + [].concat(c(r.path), [i]).join(".") + " is not an accepted parameter."));
                        var s = Object.keys(o),
                            u = We({});
        ...
        tn = function(e) {
            if (!document.body) throw new Oe("Stripe.js requires that your page has a <body> element.");
        ...
        dn = function e() {
            ...
            u(this, e), this._emit = function(e) {
                ...
                if ("string" != typeof e) throw new Oe("When adding an event listener, the first argument should be a string event name.");
                if ("function" != typeof n) throw new Oe("When adding an event listener, the second argument should be a function callback.");
        ...
        En = function(e) {
            ...
            return m(t, e), vn(t, [{
                ...
                value: function() {
                    ...
                    else if ("complete" === document.readyState || "interactive" === document.readyState) throw new Oe("Stripe.js requires that your page has a <body> element.");
        ...
        Mn = function() {
            return tn(function(e) {
                ...
                return e.style.position = "fixed", e.style.overflow = "hidden", document.documentElement && (document.documentElement.style.overflow = "visible"), e.style.top = -d + "px", e.style.left = -p + "px", e.style.right = f + "px", e.style.bottom = h + "px", Cn(function() {
                    e.style.position = n, e.style.top = r, e.style.left = o, e.style.bottom = i, e.style.right = a, e.style.overflow = c, document.documentElement && (document.documentElement.style.overflow = u), window.scrollTo(p, d)
                })
            })
        },
        jn = function(e, t) {
        ...
        Gn = function(e) {
            function t(e, n, r) {
                ...
                return o._autoMount = function() {
                    ...
                    o._backdrop.show(), Zt(o._iframe, Yn)
        ...
        Or = (be = {}, C(be, Mt.card, Sr), C(be, Mt.cardNumber, Sr), C(be, Mt.iban, Pr), C(be, Mt.auBankAccount, kr), be),
        ...
        Mr = function e(t) {
            ...
            var n = t.apiKey,
                ...
                o = t.stripeJsId,
                i = t.locale;
            this._id = Yt("__privateStripeController"), this._stripeJsId = o, this._apiKey = n, this._stripeAccount = r, this._controllerFrame = new kn(At.CONTROLLER, this._id, Tr({}, t)), this._frames = {}, this._requests = {}, this._setupPostMessage(), this._handleMessage = sn(this._handleMessage, this), this.action.fetchLocale({
                locale: i || "auto"
            })
        },
        jr = function() {
        ...
        ro = function(e, t) {
            var n = e.replace(/\/\*.*\*\//g, "").trim(),
                ...
                o = r.match(/((([^;(]*\([^()]*\)[^;)]*)|[^;]+)+)(?=;)/g);
            if (!o) throw new Oe("Found @font-face rule containing no valid font-properties in file from " + t);
            return o
        },
        oo = function(e, t) {
            var n = e.indexOf(":");
            if (-1 === n) throw new Oe("Invalid css declaration in file from " + t + ': "' + e + '"');
            var r = e.slice(0, n).trim(),
                o = Ut[r];
            if (!o) throw new Oe("Unsupported css property in file from " + t + ': "' + r + '"');
            return {
                property: o,
        ...
        io = function(e, t) {
            ...
            return ["family", "src"].forEach(function(e) {
                if (!n[e]) throw new Oe("Missing css property in file from " + t + ': "' + Ft[e] + '"')
            }), n
        },
        ao = function(e) {
            return Zr({
        ...
        Oi = null,
        Ai = function(e, t) {
            return null !== Oi ? Ne.resolve(Oi) : ki ? t && "https:" !== window.location.protocol ? (window.console && window.console.warn("To test Payment Request, you must serve this page over HTTPS."), Ne.resolve(!1)) : e ? e.action.checkCanMakePayment().then(function(e) {
                var t = e.available;
                return Oi = !0 === t
        ...
        Ii = function e(t) {
            ...
            var n = t.authentication,
                ...
                a = t.options;
            if (this._authentication = n, this._controller = r, this._mids = o, this._usesButtonElement = i, ki && "https:" === window.location.protocol) {
        ...
        Ri = function() {
            ...
            this._onEvent = function() {}, this.setEventHandler = function(t) {
                ...
                if (!e._prFrame) throw new Oe("Payment Request is not available in this browser.");
                e._prFrame.send({
                    action: "stripe-pr-show",
                    payload: {
                        data: {
        ...
        Mi = function(e) {
            function t(e) {
                ...
                if (r.warnings.forEach(function(e) {
                        return n._warn(e)
                    }), o.__billingDetailsEmailOverride && o.requestPayerEmail) throw new Oe("When providing `__billingDetailsEmailOverride`, `requestPayerEmail` has to be `false` so that the customer is not prompted for their email in the payment sheet.");
        ...
        ji = function() {
            ...
            this._usedByButtonElement = null, this._showCalledByButtonElement = !1, this._isShowing = !1, this._backingLibraries = {
                ...
                e._queryStrategy.forEach(function(n) {
                    ...
                    switch (n) {
                        case "APPLE_PAY":
                            ...
                            break;
                        case "GOOGLE_PAY":
                            e._backingLibraries.GOOGLE_PAY = new Pi(r), e._backingLibraries.GOOGLE_PAY.setEventHandler(e._handleInternalEvent);
                            break;
                        case "BROWSER":
                    ...
                    case "shippingaddresschange":
                        var n = t.type,
                            ...
                            c = function(c) {
                                ...
                                if (!(p || "shippingaddresschange" !== t.type || u.status !== _o.success || d && d.length)) throw new Oe("When requesting shipping information, you must specify shippingOptions once a shipping address is selected.\nEither provide shippingOptions in stripe.paymentRequest(...) or listen for the shippingaddresschange event and provide shippingOptions to the updateWith callback there.");
                                r.updateWith(l)
                            };
                ...
                if (e._isShowing) throw e._report("pr.update_called_while_showing"), new Oe("You cannot update Payment Request options while the payment sheet is showing.");
                e._report("pr.update", {
                    updates: t
                });
                ...
                if (e._usedByButtonElement && !e._showCalledByButtonElement && (e._report("pr.show_called_with_button"), e._warn("Do not call show() yourself if you are using the paymentRequestButton Element. The Element handles showing the payment sheet.")), !e._canMakePaymentResolved) throw e._report("pr.show_called_before_can_make_payment"), new Oe("You must first check the Payment Request API's availability using paymentRequest.canMakePayment() before calling show().");
                if (!e._activeBackingLibrary) throw e._report("pr.show_called_with_can_make_payment_false"), new Oe("Payment Request is not available in this browser.");
        ...
        Yi = function(e, t) {
            var n = Hi(e);
            if (!n) throw new Oe("A valid Element name must be provided. Valid Elements are:\n" + Object.keys(gr).filter(function(e) {
                return !gr[e].beta
            }).join(", ") + "; you passed: " + (n || (void 0 === e ? "undefined" : Ui(e))) + ".")
        },
        Gi = function(e, t, n) {
            if (Yi(e), gr[e].unique && -1 !== t.indexOf(e)) throw new Oe("Can only create one Element of type " + e + ".");
            var r = gr[e].conflict,
                o = je(t, r);
            if (o.length) {
                var i = o[0];
        ...
        ra = function(e) {
            function t(e) {
                ...
                if (a) {
                    if (!i) throw new Oe("You must pass in a stripe.paymentRequest object in order to use this Element.");
                    n._paymentRequest = i, n._paymentRequest._registerElement()
                }
                return n._createComponent(e, o), n._classes = $i, n._computeCustomClasses(e.classes || {}), n._lastBackgroundColor = "", n._destroyed = !1, n._focused = !1, n._empty = !a, n._invalid = !1, n._complete = !1, n._autofilled = !1, n._lastSubmittedAt = null, n
            }
            return te(t, e), Xi(t, [{
                key: "_checkDestroyed",
                value: function() {
                    if (this._destroyed) throw new Oe("This Element has already been destroyed. Please create a new one.")
                }
            }, {
                key: "_isMounted",
                value: function() {
                ...
                value: function(e) {
                    ...
                    if (e === t) {
                        ...
                        if (n) throw new Oe("This Element is already mounted. Use `unmount()` to unmount the Element before re-mounting.");
                        this.unmount(), this._mountTo(e)
                ...
                value: function(e) {
                    ...
                    return Object.keys(e).forEach(function(n) {
                        if (!$i[n]) throw new Oe(n + " is not a customizable class name.\nYou can customize: " + Object.keys($i).join(", "));
                        var r = e[n] || $i[n];
                        t[n] = r.replace(/\./g, " ")
                ...
                value: function(e, t) {
                    ...
                    i.className = "__PrivateStripeElement-input", i.setAttribute("aria-hidden", "true"), i.setAttribute("aria-label", " "), i.setAttribute("autocomplete", "false"), i.maxLength = 1, i.disabled = !0, Zt(o, Zi), Zt(i, ea);
                    ...
                    if (o.appendChild(i), hr && t !== Mt.paymentRequestButton) {
                        ...
                        d.className = "__PrivateStripeElement-safariInput", d.setAttribute("aria-hidden", "true"), d.setAttribute("tabindex", "-1"), d.setAttribute("autocomplete", "false"), d.maxLength = 1, d.disabled = !0, Zt(d, ea), o.appendChild(d)
                    }
        ...
        oa = function() {
            ...
            this._paymentRequest = null, this.mount = sn(function(t) {
                e._checkDestroyed();
                var n = void 0;
                if (!t) throw new Oe("Missing argument. Make sure to call mount() with a valid DOM element or selector.");
                if ("string" == typeof t) {
                    var r = document.querySelectorAll(t);
                    if (r.length > 1 && e._controller.warn("The selector you specified (" + t + ") applies to " + r.length + " DOM elements that are currently on the page.\nThe Stripe Element will be mounted to the first one."), !r.length) throw new Oe("The selector you specified (" + t + ") applies to no DOM elements that are currently on the page.\nMake sure the element exists on the page before calling mount().");
                    n = r[0]
                } else {
                    if (!t.appendChild) throw new Oe("Invalid DOM element. Make sure to call mount() with a valid DOM element or selector.");
                    n = t
                }
                if ("INPUT" === n.nodeName) throw new Oe("Stripe Elements must be mounted in a DOM element that\ncan contain child nodes. `input` elements are not permitted to have child\nnodes. Try using a `div` element instead.");
                if (n.children.length && e._controller.warn("This Element will be mounted to a DOM element that contains child nodes."), e._paymentRequest) {
                    if (!e._paymentRequest._canMakePaymentResolved) throw new Oe("For the paymentRequestButton Element, you must first check availability using paymentRequest.canMakePayment() before mounting the Element.");
                    if (!e._paymentRequest._activeBackingLibraryName) throw new Oe("The paymentRequestButton Element is not available in the current environment.");
                    e._mountToParent(n)
        ...
        ua = function e(t, n) {
            ...
            o.warnings.forEach(function(e) {
                ...
                options: n
            }), this._elements = [], this._id = Yt("elements"), this._controller = t, this._betas = i.betas || [], i.locale = Fi(i.locale, this._betas);
            var a = i.locale,
                c = i.fonts || [];
            this._controller.action.fetchLocale({
                locale: a || "auto"
        ...
        la = function() {
            ...
            this.getElement = sn(function(t) {
                var n = zi(t) || t;
                return Yi(n, e._betas), Ce(e._elements, function(e) {
        ...
        va = (Pe = {}, ie(Pe, Mt.auBankAccount, ya.au_becs_debit), ie(Pe, Mt.card, ya.card), ie(Pe, Mt.cardNumber, ya.card), ie(Pe, Mt.cardExpiry, ya.card), ie(Pe, Mt.cardCvc, ya.card), ie(Pe, Mt.postalCode, ya.card), ie(Pe, Mt.iban, ya.sepa_debit), ie(Pe, Mt.idealBank, ya.ideal), ie(Pe, Mt.fpxBank, ya.fpx), Pe),
        ba = function(e) {
        ...
        Na = function(e, t) {
            ...
            if ("object" !== (void 0 === e ? "undefined" : Ia(e))) return Ve("object", void 0 === e ? "undefined" : Ia(e), t);
            var n = e.client_secret,
                r = e.status,
                o = e.next_action,
                i = Ra(n, bt(t, "client_secret"));
            if ("error" === i.type) return i;
            if ("string" != typeof r) return Ve("string", void 0 === r ? "undefined" : Ia(r), bt(t, "status"));
            if (("requires_source_action" === r || "requires_action" === r) && "object" !== (void 0 === o ? "undefined" : Ia(o))) return Ve("object", void 0 === o ? "undefined" : Ia(o), bt(t, "next_action"));
        ...
        Ca = function(e) {
            return function(t, n) {
                if ("object" !== (void 0 === t ? "undefined" : Ia(t))) return Ve("object", void 0 === t ? "undefined" : Ia(t), n);
                if (null === t) return Ve("object", "null", n);
                var r = t.type,
                    o = ce(t, ["type"]),
                    i = void 0;
                if (null === e) {
                    if ("string" != typeof r) return Ve("string", void 0 === r ? "undefined" : Ia(r), bt(n, "type"));
                    i = r
                } else {
                    if (void 0 !== r && r !== e) return "string" != typeof r ? Ve("string", void 0 === r ? "undefined" : Ia(r), bt(n, "type")) : Ve('"' + r + '"', '"' + e + '"', bt(n, "type"));
                    i = e
                }
                var a = ["alipay", "bancontact", "eps", "giropay", "grabpay", "oxxo", "p24"],
                    c = o[i],
                    s = (o[i], ce(o, [i]));
                if (-1 !== a.indexOf(i) && void 0 === c && (c = {}), "object" !== (void 0 === c ? "undefined" : Ia(c))) return Ve("object or element", Ia(t[i]), bt(n, i));
                if (null === c) return Ve("object or element", "null", bt(n, i));
                var u = ma(c);
                if (u) {
        ...
        Ma = function(e) {
            return function(t, n) {
                if (null == t) return We(null);
                if ("object" !== (void 0 === t ? "undefined" : Ia(t))) return Ve("object", void 0 === t ? "undefined" : Ia(t), n);
                var r = t.card,
                    o = ce(t, ["card"]);
                if (!r || "object" !== (void 0 === r ? "undefined" : Ia(r))) return We(t);
                var i = r.cvc,
                    a = ce(r, ["cvc"]);
                if (null == i) return We(t);
                var c = ma(i),
        ...
        La = function(e, t) {
            return function(n, r) {
                ...
                if ("object" !== (void 0 === n ? "undefined" : Ia(n))) return Ve("object", void 0 === n ? "undefined" : Ia(n), r);
                ...
                if (null != i) throw new Oe(t + ": Expected payment_method, or source, not source_data.");
                if (null != a) throw new Oe(t + ": Expected payment_method, or source, not payment_method_data.");
                if (null != o && null != s) throw new Oe(t + ": Expected either payment_method or source, but not both.");
                if (null != o) return "string" != typeof o ? Ve("string", void 0 === o ? "undefined" : Ia(o), bt(r, "source")) : We({
                    source: o,
                    paymentMethodData: null,
                    paymentMethodOptions: null,
                    paymentMethod: null,
                ...
                if (null != s && "string" != typeof s && "object" !== (void 0 === s ? "undefined" : Ia(s))) return Ve("string or object", void 0 === s ? "undefined" : Ia(s), bt(r, "payment_method"));
                var l = gt(Ma(e), c, t, {
                    path: [].concat(ae(r.path), ["payment_method_options"])
                });
                if ("error" === l.type) return l;
                if ("string" == typeof s) return We({
                    source: null,
                    paymentMethodData: null,
        ...
        Fa = "__privateStripeMetricsController",
        Ua = {
            MERCHANT: "merchant",
            SESSION: "session"
        },
        Ha = function() {
            function e() {
                ...
                } else this._muid = this._getID(Ua.MERCHANT), this._sid = this._getID(Ua.SESSION), this._doNotPersist = !1;
                this._id = Yt(Fa), this._controllerFrame = new kn(At.METRICS_CONTROLLER, this._id, {
                    autoload: !0,
        ...
        Ga = function(e) {
            if (!e || "object" !== (void 0 === e ? "undefined" : Ya(e))) return null;
            var t = e.type,
                n = ue(e, ["type"]);
            return {
        ...
        Xa = function(e, t, n, r, o) {
            var i = ma(r),
                ...
                s = c.type,
                u = c.data;
            if (s && n !== s) return Ne.reject(new Oe("The type supplied in payment_method_data is not consistent."));
            if (i) {
                var l = i._frame.id,
                    p = i._componentName;
        ...
        $a = function(e, t, n, r, o) {
            if ("string" == typeof n) return Xa(e, t, n, r, o);
            try {
                var i = Qa(n),
                    a = i.element,
                    c = i.type,
        ...
        nc = function(e, t, n) {
            if ("valid" === gt(_a, n, t).type) throw new Oe("Do not pass an Element to stripe." + t + "() directly.\nFor more information: " + Za(t));
            var r = Et(La(e, t), n, t),
                o = r.value,
                i = o.source,
                ...
                s = o.paymentMethod,
                u = o.otherParams;
            if (null != i && (null != a || null != s)) throw new Oe(t + ": Expected either source or payment_method, but not both.");
            return a ? a.element ? {
                confirmMode: {
        ...
        Pc = function(e, t, n, r) {
            return wc(n).then(function(n) {
                return Sc(r, t + " redirect", n), wa(n, e)
            })
        },
        ...
        Cc = Nc("confirmAuBecsDebitPayment", ya.au_becs_debit),
        Mc = Nc("confirmBancontactPayment", ya.bancontact),
        jc = Nc("confirmCardPayment", ya.card),
        Lc = Nc("confirmBacsDebitPayment", ya.bacs_debit),
        xc = Nc("confirmFpxPayment", ya.fpx),
        qc = Nc("confirmEpsPayment", ya.eps),
        Dc = Nc("confirmGiropayPayment", ya.giropay),
        Bc = Nc("confirmGrabPayPayment", ya.grabpay),
        Fc = Nc("confirmIdealPayment", ya.ideal),
        Uc = Nc("confirmOxxoPayment", ya.oxxo),
        Hc = Nc("confirmAlipayPayment", ya.alipay),
        zc = Nc("confirmP24Payment", ya.p24),
        Yc = Nc("confirmSepaDebitPayment", ya.sepa_debit),
        Gc = Nc("confirmSofortPayment", ya.sofort),
        Wc = function(e, t) {
            ...
            return t.action.retrievePaymentIntent({
                ...
                switch (n.type) {
                    ...
                    case "object":
                        var r = n.object;
                        if (Oa(r.status)) {
                            if ("manual" !== r.confirmation_method) throw new Oe("handleCardAction: The PaymentIntent supplied does not require manual server-side confirmation. Please use confirmCardPayment instead to complete the payment.");
        ...
        $c = function(e, t, n, r) {
            ...
            if (null === t) return e;
            if (t !== e) throw new Oe(n + ": you specified `type: " + t + "`, but " + n + " will create a " + e + " payment method.");
            return e
        },
        Zc = function(e) {
            return function(t, n) {
                if ("object" === (void 0 === t ? "undefined" : Qc(t)) && null !== t) {
                    ...
                    if (null != i && "string" != typeof i) return Ve("string", void 0 === i ? "undefined" : Qc(i), bt(n, "payment_method"));
                    if (null != o && "object" !== (void 0 === o ? "undefined" : Qc(o))) return Ve("object", void 0 === o ? "undefined" : Qc(o), bt(n, "source_data"));
                    if (null != a && "object" !== (void 0 === a ? "undefined" : Qc(a))) return Ve("object", void 0 === a ? "undefined" : Qc(a), bt(n, "payment_method_data"));
        ...
        ts = function(e, t, n, r, o, i) {
            ...
            var c = a.value,
                ...
                f = u.paymentMethod,
                h = u.otherParams;
            if (!e && l) throw new Oe(r + ": Expected payment_method_data, not source_data.");
            if (null != p) throw new Oe("When calling " + r + " on an Element, you can't pass in a pre-existing source ID, as a source will be created using the Element.");
            if (null != f) throw new Oe("When calling " + r + " on an Element, you can't pass in a pre-existing PaymentMethod ID, as a PaymentMethod will be created using the Element.");
        ...
        ns = function(e, t, n, r, o, i) {
            var a = Et(es(t), o, r),
                ...
                p = c.paymentMethod,
                d = c.otherParams;
            if (!e && s) throw new Oe(r + ": Expected payment_method, source, or payment_method_data, not source_data.");
            if (null !== u && null !== s) throw new Oe(r + ": Expected either source or source_data, but not both.");
            if (null !== p && null !== l) throw new Oe(r + ": Expected either payment_method or payment_method_data, but not both.");
            if (null !== p && null !== u) throw new Oe(r + ": Expected either payment_method or source, but not both.");
            if (s || l) {
                var f = s || l || {},
                    h = f.type,
                    _ = f.data,
        ...
        _s = hs("confirmCardSetup", ya.card),
        ms = hs("confirmSepaDebitSetup", ya.sepa_debit),
        ys = hs("confirmAuBecsDebitSetup", ya.au_becs_debit),
        vs = hs("confirmBacsDebitSetup", ya.bacs_debit),
        bs = function(e, t) {
        ...
        Ms = function(e, t, n) {
            if (e && t || (e || t) && n) throw new Oe("stripe.redirectToCheckout: Expected only one of sku, plan, or items.");
        ...
        Ls = function(e, t, n) {
            ...
            if (i.sessionId) {
                var a = i.sessionId;
                if (Object.keys(i).length > 1) throw new Oe("stripe.redirectToCheckout: Do not provide other parameters when providing sessionId. Specify all parameters on your server when creating the CheckoutSession.");
                if (!/^cs_/.test(a)) throw new Oe("stripe.redirectToCheckout: Invalid value for sessionId. You specified '" + a + "'.");
                if ("livemode" === n && /^cs_test_/.test(a)) throw new Oe("stripe.redirectToCheckout: the provided sessionId is for a test mode Checkout Session, whereas Stripe.js was initialized with a live mode publishable key.");
                if ("testmode" === n && /^cs_live_/.test(a)) throw new Oe("stripe.redirectToCheckout: the provided sessionId is for a live mode Checkout Session, whereas Stripe.js was initialized with a test mode publishable key.");
                return {
                    tag: "session",
                    sessionId: a
                }
            ...
            if (Fr(e, "checkout_client_prices_beta") && !s && !c) throw new Oe("stripe.redirectToCheckout: You must provide one of lineItems, items, or sessionId.");
            if (!Fr(e, "checkout_client_prices_beta") && !c) throw new Oe("stripe.redirectToCheckout: You must provide one of items or sessionId.");
            if (!u || !l) throw new Oe("stripe.redirectToCheckout: You must provide successUrl and cancelUrl.");
            return Ns({
                tag: "no-session",
                items: c,
                lineItems: s,
        ...
        xs = function(e, t, n) {
            ...
            if ("no-session" === r.tag) {
                var o = r.successUrl,
                    i = r.cancelUrl;
                if (!St(o)) throw new Oe("stripe.redirectToCheckout: successUrl must start with either http:// or https://.");
                if (!St(i)) throw new Oe("stripe.redirectToCheckout: cancelUrl must start with either http:// or https://.");
                return r
            }
            return r
        },
        ...
        Ds = function(e, t, n) {
            ...
            if (Fr(e, "checkout_client_prices_beta") && r) throw new Oe("checkout_client_prices_beta cannot be used with " + r);
            switch (r) {
        ...
        zs = function(e, t, n, r) {
            return function(o) {
                ...
                var s = i,
                    ...
                    E = [];
                if (l && u) throw new Error("Only " + (Fr(t, "checkout_client_prices_beta") ? "one of items, lineItems" : "items") + " can be passed in.");
                if (l) {
                    if (!Fr(t, "checkout_client_prices_beta")) throw new Error("Field `lineItems` is invalid.");
        ...
        ru = function() {
            function e(t, n) {
                ...
                var o = Et(eu, t || {}, "Stripe()"),
                    ...
                    _ = i.betas;
                if ("" === c) throw new Oe("Please call Stripe() with your publishable key. You used an empty string.");
                if (0 === c.indexOf("sk_")) throw new Oe("You should not use your secret key with Stripe.js.\n        Please pass a publishable key instead.");
                d && d.mids && (e._ec = new za({
                    checkoutIds: d.mids
                })), this._apiKey = c, this._keyMode = Ue(c), this._betas = _ || [], this._locale = Fi(l, this._betas) || null, this._stripeAccount = s || null, this._isCheckout = !!d, this._controller = new Lr(Xs({
                    apiKey: c,
                    apiVersion: u,
                    __privateApiUrl: p,
                    stripeAccount: s,
            ...
            return $s(e, [{
                ...
                value: function(e) {
                    ...
                    this.handleCardPayment = s, this.confirmPaymentIntent = i, this.handleCardSetup = l, this.confirmSetupIntent = p, this.fulfillPaymentIntent = nu("fulfillPaymentIntent"), this.handleSepaDebitPayment = nu("handleSepaDebitPayment"), this.handleSepaDebitSetup = nu("handleSepaDebitSetup"), this.handleIdealPayment = nu("handleIdealPayment"), this.handleFpxPayment = nu("handleFpxPayment"), Fr(this._betas, Dr.payment_intent_beta_1) ? this.fulfillPaymentIntent = c : (Fr(this._betas, Dr.payment_intent_beta_3) || Fr(this._betas, Dr.payment_intent_beta_2)) && (this.handleCardPayment = c), Fr(this._betas, Dr.payment_intent_beta_3) && (this.confirmPaymentIntent = o, this.handleIdealPayment = h, this.handleSepaDebitPayment = d), Fr(this._betas, Dr.fpx_bank_beta_1) && (this.handleFpxPayment = m), Fr(this._betas, Dr.ideal_pm_beta_1) && (this.handleIdealPayment = _), Fr(this._betas, Dr.sepa_pm_beta_1) && (this.handleSepaDebitPayment = d, this.handleSepaDebitSetup = f)
                }
            }, {
                ...
                value: function(e) {
                    if (!e) throw this._controller.report("user_error.self_hosted"), new Oe("Stripe.js must be loaded from js.stripe.com. For more information https://stripe.com/docs/stripe-js/reference#including-stripejs")
                }
            }, {
                key: "_mids",
                value: function() {
    ...
    ru.version = 3, ru.stripeJsId = Gt(), ru._ec = function() {
    ...
    uu.version = iu.version, window.Stripe && 2 === window.Stripe.version && !window.Stripe.StripeV3 ? window.Stripe.StripeV3 = uu : window.Stripe ? window.console && console.warn("It looks like Stripe.js was loaded more than one time. Please only load it once per page.") : window.Stripe = uu;
    t.default = uu
}, function(e, t, n) {
    "use strict";
